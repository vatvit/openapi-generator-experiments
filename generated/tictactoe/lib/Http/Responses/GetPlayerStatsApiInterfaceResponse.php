...
/**
 * Generic response class for getPlayerStats operation
 *
 * Handles all possible HTTP status codes for this operation:
 * - 200: Successful response
 * - 404: Not Found - Resource does not exist
 */
final class GetPlayerStatsApiInterfaceResponse implements GetPlayerStatsApiInterfaceResponseInterface
{

    public function __construct(
        private readonly int $statusCode,
        private readonly \TicTacToeApiV2\Server\Models\PlayerStats|\TicTacToeApiV2\Server\Models\NotFoundError $data,
