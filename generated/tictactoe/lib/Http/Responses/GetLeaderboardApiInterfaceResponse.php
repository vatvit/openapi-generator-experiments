...
/**
 * Generic response class for getLeaderboard operation
 *
 * Handles all possible HTTP status codes for this operation:
 * - 200: Successful response
 */
final class GetLeaderboardApiInterfaceResponse implements GetLeaderboardApiInterfaceResponseInterface
{
