...
/**
 * Generic response class for getMoves operation
 *
 * Handles all possible HTTP status codes for this operation:
 * - 200: Successful response
 * - 404: Not Found - Resource does not exist
 */
final class GetMovesApiInterfaceResponse implements GetMovesApiInterfaceResponseInterface
{

    public function __construct(
        private readonly int $statusCode,
        private readonly \TicTacToeApiV2\Server\Models\MoveHistory|\TicTacToeApiV2\Server\Models\NotFoundError $data,
