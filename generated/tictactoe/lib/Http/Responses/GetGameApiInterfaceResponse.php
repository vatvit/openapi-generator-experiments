...
/**
 * Generic response class for getGame operation
 *
 * Handles all possible HTTP status codes for this operation:
 * - 200: Successful response
 * - 404: Not Found - Resource does not exist
 */
final class GetGameApiInterfaceResponse implements GetGameApiInterfaceResponseInterface
{

    public function __construct(
        private readonly int $statusCode,
        private readonly \TicTacToeApiV2\Server\Models\Game|\TicTacToeApiV2\Server\Models\NotFoundError $data,
