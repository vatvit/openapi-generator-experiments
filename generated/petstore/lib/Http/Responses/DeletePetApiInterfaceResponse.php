...
/**
 * Generic response class for deletePet operation
 *
 * Handles all possible HTTP status codes for this operation:
 * - 204: pet deleted
 * - 0: unexpected error
 */
final class DeletePetApiInterfaceResponse implements DeletePetApiInterfaceResponseInterface
{

    public function __construct(
        private readonly int $statusCode,
        private readonly \PetStoreApiV2\Server\Models\NoContent204|\PetStoreApiV2\Server\Models\Error $data,
