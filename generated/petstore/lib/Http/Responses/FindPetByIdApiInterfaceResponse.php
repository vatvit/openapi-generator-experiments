...
/**
 * Generic response class for findPetById operation
 *
 * Handles all possible HTTP status codes for this operation:
 * - 200: pet response
 * - 0: unexpected error
 */
final class FindPetByIdApiInterfaceResponse implements FindPetByIdApiInterfaceResponseInterface
{

    public function __construct(
        private readonly int $statusCode,
        private readonly \PetStoreApiV2\Server\Models\Pet|\PetStoreApiV2\Server\Models\Error $data,
