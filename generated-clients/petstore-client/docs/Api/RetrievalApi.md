...
$apiInstance = new PetStoreClient\Api\RetrievalApi(
...
try {
    ...
    echo 'Exception when calling RetrievalApi->findPetById: ', $e->getMessage(), PHP_EOL;
}
```
