...
$apiInstance = new PetStoreClient\Api\ReportingApi(
...
try {
    ...
    echo 'Exception when calling ReportingApi->findPets: ', $e->getMessage(), PHP_EOL;
}
```
