...
$apiInstance = new PetStoreClient\Api\InventoryApi(
...
try {
    ...
    echo 'Exception when calling InventoryApi->findPets: ', $e->getMessage(), PHP_EOL;
}
```
