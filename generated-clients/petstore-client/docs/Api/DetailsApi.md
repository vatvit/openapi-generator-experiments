...
$apiInstance = new PetStoreClient\Api\DetailsApi(
...
try {
    ...
    echo 'Exception when calling DetailsApi->findPetById: ', $e->getMessage(), PHP_EOL;
}
```
