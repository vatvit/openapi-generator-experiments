 ...
 * ]);
 */
$route = $router->POST('/v1/games', [TicTacToeApiTest\Server\Http\Controllers\CreateGameController::class, 'createGame'])
    ->name('api.createGame');
...
// - TicTacToeApiTest\Server\Security\bearerHttpAuthenticationInterface
 ...
 * ]);
 */
$route = $router->DELETE('/v1/games/{gameId}', [TicTacToeApiTest\Server\Http\Controllers\DeleteGameController::class, 'deleteGame'])
    ->name('api.deleteGame');
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/board', [TicTacToeApiTest\Server\Http\Controllers\GetBoardController::class, 'getBoard'])
    ->name('api.getBoard');
...
// - TicTacToeApiTest\Server\Security\defaultApiKeyInterface
// - TicTacToeApiTest\Server\Security\app2AppOauthInterface
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}', [TicTacToeApiTest\Server\Http\Controllers\GetGameController::class, 'getGame'])
    ->name('api.getGame');
 ...
 */
$route = $router->GET('/v1/leaderboard', [TicTacToeApiTest\Server\Http\Controllers\GetLeaderboardController::class, 'getLeaderboard'])
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/moves', [TicTacToeApiTest\Server\Http\Controllers\GetMovesController::class, 'getMoves'])
    ->name('api.getMoves');
 ...
 * ]);
 */
$route = $router->GET('/v1/players/{playerId}/stats', [TicTacToeApiTest\Server\Http\Controllers\GetPlayerStatsController::class, 'getPlayerStats'])
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/board/{row}/{column}', [TicTacToeApiTest\Server\Http\Controllers\GetSquareController::class, 'getSquare'])
    ->name('api.getSquare');
...
// - TicTacToeApiTest\Server\Security\bearerHttpAuthenticationInterface
// - TicTacToeApiTest\Server\Security\user2AppOauthInterface
 ...
 * ]);
 */
$route = $router->GET('/v1/games', [TicTacToeApiTest\Server\Http\Controllers\ListGamesController::class, 'listGames'])
    ->name('api.listGames');
 ...
 * ]);
 */
$route = $router->PUT('/v1/games/{gameId}/board/{row}/{column}', [TicTacToeApiTest\Server\Http\Controllers\PutSquareController::class, 'putSquare'])
    ->name('api.putSquare');
...
if (config('app.debug', false)) {
    ...
    if (class_exists(TicTacToeApiTest\Server\Security\SecurityValidator::class)) {
        try {
            TicTacToeApiTest\Server\Security\SecurityValidator::validateMiddleware($router);
        } catch (\RuntimeException $e) {
            // Log validation errors but don't break the application
            error_log("Security middleware validation failed for TicTacToeApiTest\Server:");
