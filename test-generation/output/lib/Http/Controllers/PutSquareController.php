...
use TicTacToeApiTest\Server\Api\PutSquareHandlerInterface;
use TicTacToeApiTest\Server\Api\PutSquareResponseInterface;
use \TicTacToeApiTest\Server\Models\MoveRequest;
...
class PutSquareController extends Controller
{
     ...
     * - moveRequest: required, \TicTacToeApiTest\Server\Models\MoveRequest
     *
     * Path parameters:
     * - gameId: string
     * - row: int
    ...
    ): JsonResponse
    {
        ...
        // Deserialize request body to \TicTacToeApiTest\Server\Models\MoveRequest model
        $serde = new SerdeCommon();
        $moveRequest = $serde->deserialize($request->getContent(), from: 'json', to: \TicTacToeApiTest\Server\Models\MoveRequest::class);
