...
use TicTacToeApiTest\Server\Api\ListGamesHandlerInterface;
use TicTacToeApiTest\Server\Api\ListGamesResponseInterface;
...
class ListGamesController extends Controller
{
     ...
     * - status: \TicTacToeApiTest\Server\Models\GameStatus
     * - playerId: string
     *
