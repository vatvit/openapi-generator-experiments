...
use TicTacToeApiTest\Server\Api\GetLeaderboardHandlerInterface;
use TicTacToeApiTest\Server\Api\GetLeaderboardResponseInterface;
...
class GetLeaderboardController extends Controller
{
     ...
     * - timeframe: \TicTacToeApiTest\Server\Models\GetLeaderboardTimeframeParameter
