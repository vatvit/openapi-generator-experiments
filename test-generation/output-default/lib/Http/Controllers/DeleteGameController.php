...
use TicTacToeApiMinimal\Server\Api\DeleteGameApiInterface;
...
class DeleteGameController extends Controller
{
    ...
    public function __construct(
        private readonly DeleteGameApiInterface $api,
    ...
    public function deleteGame(Request $request, string $gameId): JsonResponse
    {
        ...
        if ($apiResult instanceof \TicTacToeApiMinimal\Server\Models\NoContent204) {
            return response()->json($this->serde->serialize($apiResult, format: 'array'), 204);
        }

        if ($apiResult instanceof \TicTacToeApiMinimal\Server\Models\ForbiddenError) {
