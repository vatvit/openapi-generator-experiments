...
use TicTacToeApiMinimal\Server\Api\GetPlayerStatsApiInterface;
...
class GetPlayerStatsController extends Controller
{
    ...
    public function __construct(
        private readonly GetPlayerStatsApiInterface $api,
    ...
    public function getPlayerStats(Request $request, string $playerId): JsonResponse
    {
        ...
        if ($apiResult instanceof \TicTacToeApiMinimal\Server\Models\PlayerStats) {
