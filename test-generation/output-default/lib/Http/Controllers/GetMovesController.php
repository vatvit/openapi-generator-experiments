...
use TicTacToeApiMinimal\Server\Api\GetMovesApiInterface;
...
class GetMovesController extends Controller
{
    ...
    public function __construct(
        private readonly GetMovesApiInterface $api,
    ...
    public function getMoves(Request $request, string $gameId): JsonResponse
    {
        ...
        if ($apiResult instanceof \TicTacToeApiMinimal\Server\Models\MoveHistory) {
