...
use TicTacToeApiFinal\Server\Api\GetLeaderboardHandlerInterface;
use TicTacToeApiFinal\Server\Api\GetLeaderboardResponseInterface;
...
class GetLeaderboardController extends Controller
{
     ...
     * - timeframe: \TicTacToeApiFinal\Server\Models\GetLeaderboardTimeframeParameter
