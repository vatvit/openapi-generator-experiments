...
use TicTacToeApiFinal\Server\Api\PutSquareHandlerInterface;
use TicTacToeApiFinal\Server\Api\PutSquareResponseInterface;
use \TicTacToeApiFinal\Server\Models\MoveRequest;
...
class PutSquareController extends Controller
{
     ...
     * - moveRequest: required, \TicTacToeApiFinal\Server\Models\MoveRequest
     *
     * Path parameters:
     * - gameId: string
     * - row: int
    ...
    ): JsonResponse
    {
        ...
        // Deserialize request body to \TicTacToeApiFinal\Server\Models\MoveRequest model
        $serde = new SerdeCommon();
        $moveRequest = $serde->deserialize($request->getContent(), from: 'json', to: \TicTacToeApiFinal\Server\Models\MoveRequest::class);
