...
use TicTacToeApiFinal\Server\Api\ListGamesHandlerInterface;
use TicTacToeApiFinal\Server\Api\ListGamesResponseInterface;
...
class ListGamesController extends Controller
{
     ...
     * - status: \TicTacToeApiFinal\Server\Models\GameStatus
     * - playerId: string
     *
