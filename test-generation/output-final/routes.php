 ...
 * ]);
 */
$route = $router->POST('/v1/games', [TicTacToeApiFinal\Server\Http\Controllers\CreateGameController::class, 'createGame'])
    ->name('api.createGame');
...
// - TicTacToeApiFinal\Server\Security\bearerHttpAuthenticationInterface
 ...
 * ]);
 */
$route = $router->DELETE('/v1/games/{gameId}', [TicTacToeApiFinal\Server\Http\Controllers\DeleteGameController::class, 'deleteGame'])
    ->name('api.deleteGame');
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/board', [TicTacToeApiFinal\Server\Http\Controllers\GetBoardController::class, 'getBoard'])
    ->name('api.getBoard');
...
// - TicTacToeApiFinal\Server\Security\defaultApiKeyInterface
// - TicTacToeApiFinal\Server\Security\app2AppOauthInterface
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}', [TicTacToeApiFinal\Server\Http\Controllers\GetGameController::class, 'getGame'])
    ->name('api.getGame');
 ...
 */
$route = $router->GET('/v1/leaderboard', [TicTacToeApiFinal\Server\Http\Controllers\GetLeaderboardController::class, 'getLeaderboard'])
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/moves', [TicTacToeApiFinal\Server\Http\Controllers\GetMovesController::class, 'getMoves'])
    ->name('api.getMoves');
 ...
 * ]);
 */
$route = $router->GET('/v1/players/{playerId}/stats', [TicTacToeApiFinal\Server\Http\Controllers\GetPlayerStatsController::class, 'getPlayerStats'])
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/board/{row}/{column}', [TicTacToeApiFinal\Server\Http\Controllers\GetSquareController::class, 'getSquare'])
    ->name('api.getSquare');
...
// - TicTacToeApiFinal\Server\Security\bearerHttpAuthenticationInterface
// - TicTacToeApiFinal\Server\Security\user2AppOauthInterface
 ...
 * ]);
 */
$route = $router->GET('/v1/games', [TicTacToeApiFinal\Server\Http\Controllers\ListGamesController::class, 'listGames'])
    ->name('api.listGames');
 ...
 * ]);
 */
$route = $router->PUT('/v1/games/{gameId}/board/{row}/{column}', [TicTacToeApiFinal\Server\Http\Controllers\PutSquareController::class, 'putSquare'])
    ->name('api.putSquare');
...
if (config('app.debug', false)) {
    ...
    if (class_exists(TicTacToeApiFinal\Server\Security\SecurityValidator::class)) {
        try {
            TicTacToeApiFinal\Server\Security\SecurityValidator::validateMiddleware($router);
        } catch (\RuntimeException $e) {
            // Log validation errors but don't break the application
            error_log("Security middleware validation failed for TicTacToeApiFinal\Server:");
