...
namespace TicTacToeTestNoSuffix\Server\Http\Controllers;

use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use TicTacToeTestNoSuffix\Server\Api\CreateGameHandlerInterface;
use TicTacToeTestNoSuffix\Server\Api\CreateGameResponseInterface;
use \TicTacToeTestNoSuffix\Server\Models\CreateGameRequest;
...
class CreateGameController extends Controller
{
     ...
     * - createGameRequest: required, \TicTacToeTestNoSuffix\Server\Models\CreateGameRequest
     *
    ...
    ): JsonResponse
    {
        ...
        // Deserialize request body to \TicTacToeTestNoSuffix\Server\Models\CreateGameRequest model
        $serde = new SerdeCommon();
        $createGameRequest = $serde->deserialize($request->getContent(), from: 'json', to: \TicTacToeTestNoSuffix\Server\Models\CreateGameRequest::class);
