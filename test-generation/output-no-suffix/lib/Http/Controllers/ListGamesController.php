...
use TicTacToeTestNoSuffix\Server\Api\ListGamesHandlerInterface;
use TicTacToeTestNoSuffix\Server\Api\ListGamesResponseInterface;
...
class ListGamesController extends Controller
{
     ...
     * - status: \TicTacToeTestNoSuffix\Server\Models\GameStatus
     * - playerId: string
     *
