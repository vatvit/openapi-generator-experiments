...
use TicTacToeTestNoSuffix\Server\Api\PutSquareHandlerInterface;
use TicTacToeTestNoSuffix\Server\Api\PutSquareResponseInterface;
use \TicTacToeTestNoSuffix\Server\Models\MoveRequest;
...
class PutSquareController extends Controller
{
     ...
     * - moveRequest: required, \TicTacToeTestNoSuffix\Server\Models\MoveRequest
     *
     * Path parameters:
     * - gameId: string
     * - row: int
    ...
    ): JsonResponse
    {
        ...
        // Deserialize request body to \TicTacToeTestNoSuffix\Server\Models\MoveRequest model
        $serde = new SerdeCommon();
        $moveRequest = $serde->deserialize($request->getContent(), from: 'json', to: \TicTacToeTestNoSuffix\Server\Models\MoveRequest::class);
