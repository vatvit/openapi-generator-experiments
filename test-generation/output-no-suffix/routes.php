 ...
 * ]);
 */
$route = $router->POST('/v1/games', [TicTacToeTestNoSuffix\Server\Http\Controllers\CreateGameController::class, 'createGame'])
    ->name('api.createGame');
...
// - TicTacToeTestNoSuffix\Server\Security\bearerHttpAuthenticationInterface
 ...
 * ]);
 */
$route = $router->DELETE('/v1/games/{gameId}', [TicTacToeTestNoSuffix\Server\Http\Controllers\DeleteGameController::class, 'deleteGame'])
    ->name('api.deleteGame');
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/board', [TicTacToeTestNoSuffix\Server\Http\Controllers\GetBoardController::class, 'getBoard'])
    ->name('api.getBoard');
...
// - TicTacToeTestNoSuffix\Server\Security\defaultApiKeyInterface
// - TicTacToeTestNoSuffix\Server\Security\app2AppOauthInterface
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}', [TicTacToeTestNoSuffix\Server\Http\Controllers\GetGameController::class, 'getGame'])
    ->name('api.getGame');
 ...
 */
$route = $router->GET('/v1/leaderboard', [TicTacToeTestNoSuffix\Server\Http\Controllers\GetLeaderboardController::class, 'getLeaderboard'])
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/moves', [TicTacToeTestNoSuffix\Server\Http\Controllers\GetMovesController::class, 'getMoves'])
    ->name('api.getMoves');
 ...
 * ]);
 */
$route = $router->GET('/v1/players/{playerId}/stats', [TicTacToeTestNoSuffix\Server\Http\Controllers\GetPlayerStatsController::class, 'getPlayerStats'])
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/board/{row}/{column}', [TicTacToeTestNoSuffix\Server\Http\Controllers\GetSquareController::class, 'getSquare'])
    ->name('api.getSquare');
...
// - TicTacToeTestNoSuffix\Server\Security\bearerHttpAuthenticationInterface
// - TicTacToeTestNoSuffix\Server\Security\user2AppOauthInterface
 ...
 * ]);
 */
$route = $router->GET('/v1/games', [TicTacToeTestNoSuffix\Server\Http\Controllers\ListGamesController::class, 'listGames'])
    ->name('api.listGames');
 ...
 * ]);
 */
$route = $router->PUT('/v1/games/{gameId}/board/{row}/{column}', [TicTacToeTestNoSuffix\Server\Http\Controllers\PutSquareController::class, 'putSquare'])
    ->name('api.putSquare');
...
if (config('app.debug', false)) {
    ...
    if (class_exists(TicTacToeTestNoSuffix\Server\Security\SecurityValidator::class)) {
        try {
            TicTacToeTestNoSuffix\Server\Security\SecurityValidator::validateMiddleware($router);
        } catch (\RuntimeException $e) {
            // Log validation errors but don't break the application
            error_log("Security middleware validation failed for TicTacToeTestNoSuffix\Server:");
