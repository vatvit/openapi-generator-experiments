...
use TicTacToeApiV2Test\Server\Api\PutSquareHandlerInterface;
use TicTacToeApiV2Test\Server\Api\PutSquareResponseInterface;
use \TicTacToeApiV2Test\Server\Models\MoveRequest;
...
class PutSquareController extends Controller
{
     ...
     * - moveRequest: required, \TicTacToeApiV2Test\Server\Models\MoveRequest
     *
     * Path parameters:
     * - gameId: string
     * - row: int
    ...
    ): JsonResponse
    {
        ...
        // Deserialize request body to \TicTacToeApiV2Test\Server\Models\MoveRequest model
        $serde = new SerdeCommon();
        $moveRequest = $serde->deserialize($request->getContent(), from: 'json', to: \TicTacToeApiV2Test\Server\Models\MoveRequest::class);
