...
use TicTacToeApiV2Test\Server\Api\ListGamesHandlerInterface;
use TicTacToeApiV2Test\Server\Api\ListGamesResponseInterface;
...
class ListGamesController extends Controller
{
     ...
     * - status: \TicTacToeApiV2Test\Server\Models\GameStatus
     * - playerId: string
     *
