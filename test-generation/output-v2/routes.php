 ...
 * ]);
 */
$route = $router->POST('/v1/games', [TicTacToeApiV2Test\Server\Http\Controllers\CreateGameController::class, 'createGame'])
    ->name('api.createGame');
...
// - TicTacToeApiV2Test\Server\Security\bearerHttpAuthenticationInterface
 ...
 * ]);
 */
$route = $router->DELETE('/v1/games/{gameId}', [TicTacToeApiV2Test\Server\Http\Controllers\DeleteGameController::class, 'deleteGame'])
    ->name('api.deleteGame');
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/board', [TicTacToeApiV2Test\Server\Http\Controllers\GetBoardController::class, 'getBoard'])
    ->name('api.getBoard');
...
// - TicTacToeApiV2Test\Server\Security\defaultApiKeyInterface
// - TicTacToeApiV2Test\Server\Security\app2AppOauthInterface
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}', [TicTacToeApiV2Test\Server\Http\Controllers\GetGameController::class, 'getGame'])
    ->name('api.getGame');
 ...
 */
$route = $router->GET('/v1/leaderboard', [TicTacToeApiV2Test\Server\Http\Controllers\GetLeaderboardController::class, 'getLeaderboard'])
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/moves', [TicTacToeApiV2Test\Server\Http\Controllers\GetMovesController::class, 'getMoves'])
    ->name('api.getMoves');
 ...
 * ]);
 */
$route = $router->GET('/v1/players/{playerId}/stats', [TicTacToeApiV2Test\Server\Http\Controllers\GetPlayerStatsController::class, 'getPlayerStats'])
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/board/{row}/{column}', [TicTacToeApiV2Test\Server\Http\Controllers\GetSquareController::class, 'getSquare'])
    ->name('api.getSquare');
...
// - TicTacToeApiV2Test\Server\Security\bearerHttpAuthenticationInterface
// - TicTacToeApiV2Test\Server\Security\user2AppOauthInterface
 ...
 * ]);
 */
$route = $router->GET('/v1/games', [TicTacToeApiV2Test\Server\Http\Controllers\ListGamesController::class, 'listGames'])
    ->name('api.listGames');
 ...
 * ]);
 */
$route = $router->PUT('/v1/games/{gameId}/board/{row}/{column}', [TicTacToeApiV2Test\Server\Http\Controllers\PutSquareController::class, 'putSquare'])
    ->name('api.putSquare');
...
if (config('app.debug', false)) {
    ...
    if (class_exists(TicTacToeApiV2Test\Server\Security\SecurityValidator::class)) {
        try {
            TicTacToeApiV2Test\Server\Security\SecurityValidator::validateMiddleware($router);
        } catch (\RuntimeException $e) {
            // Log validation errors but don't break the application
            error_log("Security middleware validation failed for TicTacToeApiV2Test\Server:");
