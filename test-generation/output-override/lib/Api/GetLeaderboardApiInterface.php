...
namespace TicTacToeApiOverride\Server\Api;
...
interface GetLeaderboardApiInterface
{
     ...
     *
     * @param \TicTacToeApiOverride\Server\Models\GetLeaderboardTimeframeParameter $timeframe Timeframe for leaderboard statistics
     * @param int $limit Number of top players to return
     * @return GetLeaderboardResponseInterface
     */
    public function handle(
        ?\TicTacToeApiOverride\Server\Models\GetLeaderboardTimeframeParameter $timeframe,
        ?int $limit
