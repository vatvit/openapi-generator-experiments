...
use \TicTacToeApiOverride\Server\Models\CreateGameRequest;
...
class CreateGameController extends Controller
{
     ...
     * - createGameRequest: required, \TicTacToeApiOverride\Server\Models\CreateGameRequest
     *
    ...
    ): JsonResponse
    {
        ...
        // Deserialize request body to \TicTacToeApiOverride\Server\Models\CreateGameRequest model
        $serde = new SerdeCommon();
        $createGameRequest = $serde->deserialize($request->getContent(), from: 'json', to: \TicTacToeApiOverride\Server\Models\CreateGameRequest::class);
