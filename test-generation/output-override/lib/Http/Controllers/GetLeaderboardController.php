...
use TicTacToeApiOverride\Server\Api\GetLeaderboardApiInterface;
use TicTacToeApiOverride\Server\Http\Responses\GetLeaderboardResponseInterface;
...
class GetLeaderboardController extends Controller
{
     ...
     * - timeframe: \TicTacToeApiOverride\Server\Models\GetLeaderboardTimeframeParameter
