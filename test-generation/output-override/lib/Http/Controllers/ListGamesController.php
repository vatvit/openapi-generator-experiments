...
use TicTacToeApiOverride\Server\Api\ListGamesApiInterface;
use TicTacToeApiOverride\Server\Http\Responses\ListGamesResponseInterface;
...
class ListGamesController extends Controller
{
     ...
     * - status: \TicTacToeApiOverride\Server\Models\GameStatus
     * - playerId: string
     *
