...
namespace TicTacToeApiOverride\Server\Http\Controllers;

use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use TicTacToeApiOverride\Server\Api\PutSquareApiInterface;
use TicTacToeApiOverride\Server\Http\Responses\PutSquareResponseInterface;
use \TicTacToeApiOverride\Server\Models\MoveRequest;
...
class PutSquareController extends Controller
{
     ...
     * - moveRequest: required, \TicTacToeApiOverride\Server\Models\MoveRequest
     *
     * Path parameters:
     * - gameId: string
     * - row: int
    ...
    ): JsonResponse
    {
        ...
        // Deserialize request body to \TicTacToeApiOverride\Server\Models\MoveRequest model
        $serde = new SerdeCommon();
        $moveRequest = $serde->deserialize($request->getContent(), from: 'json', to: \TicTacToeApiOverride\Server\Models\MoveRequest::class);
