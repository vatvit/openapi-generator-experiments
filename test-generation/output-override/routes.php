 ...
 * ]);
 */
$route = $router->POST('/v1/games', [TicTacToeApiOverride\Server\Http\Controllers\CreateGameController::class, 'createGame'])
    ->name('api.createGame');
...
// - TicTacToeApiOverride\Server\Security\bearerHttpAuthenticationInterface
 ...
 * ]);
 */
$route = $router->DELETE('/v1/games/{gameId}', [TicTacToeApiOverride\Server\Http\Controllers\DeleteGameController::class, 'deleteGame'])
    ->name('api.deleteGame');
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/board', [TicTacToeApiOverride\Server\Http\Controllers\GetBoardController::class, 'getBoard'])
    ->name('api.getBoard');
...
// - TicTacToeApiOverride\Server\Security\defaultApiKeyInterface
// - TicTacToeApiOverride\Server\Security\app2AppOauthInterface
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}', [TicTacToeApiOverride\Server\Http\Controllers\GetGameController::class, 'getGame'])
    ->name('api.getGame');
 ...
 */
$route = $router->GET('/v1/leaderboard', [TicTacToeApiOverride\Server\Http\Controllers\GetLeaderboardController::class, 'getLeaderboard'])
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/moves', [TicTacToeApiOverride\Server\Http\Controllers\GetMovesController::class, 'getMoves'])
    ->name('api.getMoves');
 ...
 * ]);
 */
$route = $router->GET('/v1/players/{playerId}/stats', [TicTacToeApiOverride\Server\Http\Controllers\GetPlayerStatsController::class, 'getPlayerStats'])
 ...
 * ]);
 */
$route = $router->GET('/v1/games/{gameId}/board/{row}/{column}', [TicTacToeApiOverride\Server\Http\Controllers\GetSquareController::class, 'getSquare'])
    ->name('api.getSquare');
...
// - TicTacToeApiOverride\Server\Security\bearerHttpAuthenticationInterface
// - TicTacToeApiOverride\Server\Security\user2AppOauthInterface
 ...
 * ]);
 */
$route = $router->GET('/v1/games', [TicTacToeApiOverride\Server\Http\Controllers\ListGamesController::class, 'listGames'])
    ->name('api.listGames');
 ...
 * ]);
 */
$route = $router->PUT('/v1/games/{gameId}/board/{row}/{column}', [TicTacToeApiOverride\Server\Http\Controllers\PutSquareController::class, 'putSquare'])
    ->name('api.putSquare');
...
if (config('app.debug', false)) {
    ...
    if (class_exists(TicTacToeApiOverride\Server\Security\SecurityValidator::class)) {
        try {
            TicTacToeApiOverride\Server\Security\SecurityValidator::validateMiddleware($router);
        } catch (\RuntimeException $e) {
            // Log validation errors but don't break the application
            error_log("Security middleware validation failed for TicTacToeApiOverride\Server:");
