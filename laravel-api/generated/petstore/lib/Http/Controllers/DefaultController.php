...
namespace PetStoreApi\Scaffolding\Http\Controllers;
...
class DefaultController extends Controller
{
     ...
     * - newPet: required, \PetStoreApi\Scaffolding\Models\NewPet
     *
    ...
    ): JsonResponse
    {
        ...
        // Deserialize request body to \PetStoreApi\Scaffolding\Models\NewPet model
        $serde = new SerdeCommon();
        $newPet = $serde->deserialize($request->getContent(), from: 'json', to: \PetStoreApi\Scaffolding\Models\NewPet::class);
